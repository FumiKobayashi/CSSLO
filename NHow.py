...
@nb.jit(
    nb.types.Tuple((nb.int8[:, :], nb.int64[:]))(
        nb.int8[:, :], nb.int64, nb.int64, nb.int64, nb.int64
    )
)
...
@nb.jit(
    nb.types.Tuple((nb.int16[:, :], nb.types.List(nb.int64)))(
        nb.int16[:, :], nb.int16, nb.int64, nb.int64, nb.int64, nb.int64
    )
)
